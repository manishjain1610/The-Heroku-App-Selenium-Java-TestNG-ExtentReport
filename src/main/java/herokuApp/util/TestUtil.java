...
public class TestUtil 
{
	...
	public static String randomString()
	{
		...
		// String generatedString = RandomStringUtils.random(24, "abcdefghijklmnopqrstuvwxyz0123456789")
		RandomStringGenerator generator = new RandomStringGenerator.Builder()
				.withinRange('a', 'z') // Define the range of characters
				.get();

		String generatedString = generator.generate(8);
	...
	public static String[][] getDataFromXL() throws Exception
	{
		...
		File xlFile = new File(System.getProperty("user.dir")+"\\src\\main\\java\\herokuApp\\testdata\\LoginData.xlsx");
